...
pub async fn update_shallow_repo(target_dir: &PathBuf) -> Result<(), anyhow::Error> {
    info!("更新之前clone的shallow仓库: {}", target_dir.display());
...
pub async fn restore_repo(target_dir: &PathBuf) -> Result<(), anyhow::Error> {
